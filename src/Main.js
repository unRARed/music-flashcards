// elm-watch hot {"version":"2.0.0-beta.2","targetName":"main","webSocketConnection":3000}
"use strict";
(() => {
...
var $author$project$Main$Card = function (name) {
	return {name: name};
};
var $author$project$Main$defaultCard = $author$project$Main$Card('C4');
var $author$project$Main$allCards = _List_fromArray(
	[
		$author$project$Main$defaultCard,
		$author$project$Main$Card('A2'),
		$author$project$Main$Card('A3'),
		$author$project$Main$Card('A4'),
		$author$project$Main$Card('A5'),
		$author$project$Main$Card('A6'),
		$author$project$Main$Card('B2'),
		$author$project$Main$Card('B3'),
		$author$project$Main$Card('B4'),
		$author$project$Main$Card('B5'),
		$author$project$Main$Card('B6'),
		$author$project$Main$Card('C2'),
		$author$project$Main$Card('C3'),
		$author$project$Main$Card('C4'),
		$author$project$Main$Card('C5'),
		$author$project$Main$Card('C6'),
		$author$project$Main$Card('D2'),
		$author$project$Main$Card('D3'),
		$author$project$Main$Card('D4'),
		$author$project$Main$Card('D5'),
		$author$project$Main$Card('D6'),
		$author$project$Main$Card('E2'),
		$author$project$Main$Card('E3'),
		$author$project$Main$Card('E4'),
		$author$project$Main$Card('E5'),
		$author$project$Main$Card('E6'),
		$author$project$Main$Card('F2'),
		$author$project$Main$Card('F3'),
		$author$project$Main$Card('F4'),
		$author$project$Main$Card('F5'),
		$author$project$Main$Card('F6'),
		$author$project$Main$Card('G2'),
		$author$project$Main$Card('G3'),
		$author$project$Main$Card('G4'),
		$author$project$Main$Card('G5'),
		$author$project$Main$Card('G6')
	]);
...
var $author$project$Main$shuffleCards = function (deck) {
	var shuffledCards = $elm_community$random_extra$Random$List$shuffle(deck);
	return A2(
		$elm$random$Random$step,
		shuffledCards,
		$elm$random$Random$initialSeed(123)).a;
};
...
var $author$project$Main$getCard = function (model) {
	var cards = $elm$core$Array$fromList(model.cards);
	var card = A2($elm$core$Array$get, model.cardIndex, cards);
	if (card.$ === 'Just') {
		var t = card.a;
		return t;
	} else {
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$src('/images/' + (card.name + ('_' + (face + '.JPG')))),
								$elm$html$Html$Attributes$class('c-flash__card-back')
							]),
						_List_Nil)
					])),
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('c-flash__controls')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Main$PreviousCard),
								$elm$html$Html$Attributes$class(
								isFirstCard ? 'disabled' : ''),
								$elm$html$Html$Attributes$disabled(isFirstCard)
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('c-flash__indicator')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(cardNumber + (' / ' + totalCards))
							])),
						A2(
						$elm$html$Html$button,
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Main$NextCard),
								$elm$html$Html$Attributes$class(
								isLastCard ? 'disabled' : ''),
								$elm$html$Html$Attributes$disabled(isLastCard)
							]),
						_List_fromArray(
							[
